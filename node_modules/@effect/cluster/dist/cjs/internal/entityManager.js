            ...
            case "Exit":
              {
                ...
                // interrupt.
                if (storageEnabled && Context.get(request.rpc.annotations, _ClusterSchema.Persisted) && Exit.isFailure(response.exit) && Exit.isInterrupted(response.exit) && (isShuttingDown || Context.get(request.rpc.annotations, _ClusterSchema.Uninterruptible) || isInterruptIgnore(response.exit.cause))) {
